        ...
        <div className="sticky top-24 max-h-[calc(100vh-6rem)] space-y-5 overflow-y-auto pb-5">
          ...
          <SidebarCard>
            ...
            <div className="mt-4 space-y-2">
              {relatedPages.map((title) => (
                <a key={title} href="#why-families-choose" className="block rounded-md bg-[#fbf9fd] px-3 py-2 text-[12px] font-bold text-[#51465a] transition hover:bg-[#f0e7f6] hover:text-[#7835A4]">{title}</a>
              ))}
            </div>
          </SidebarCard>
