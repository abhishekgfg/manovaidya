...
const schemaGraph = [
  {
    ...
    "@type": "MedicalWebPage",
    name: "Confusion & Disorientation Support for Seniors in India",
    url: "https://www.manovaidya.com/confusion-disorientation-support-seniors-india/",
    headline: "Confusion & Disorientation Support for Seniors in India",
    description: "Looking for Confusion & Disorientation Support for Seniors in India? Learn about confusion in older adults, disorientation, possible causes, cognitive wellbeing and the Neuro-Ayurveda approach at Manovaidya.",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Confusion & Disorientation Support", item: "https://www.manovaidya.com/confusion-disorientation-support-seniors-india/" },
    ],
  },
  {
    "@context": "https://schema.org",
...
function ConfusionDisorientationSupportPage() {
  ...
  React.useEffect(() => {
    document.title = "Confusion & Disorientation Support for Seniors in India | Cognitive Health & Healthy Ageing | Manovaidya";
    const description = "Looking for Confusion & Disorientation Support for Seniors in India? Learn about confusion in older adults, disorientation, possible causes, cognitive wellbeing and the Neuro-Ayurveda approach at Manovaidya.";
    ...
    <main className="min-h-screen bg-white text-[#1f1726]" style={{ font: '400 1.125rem/1.5 "Martel", serif' }}>
      <section className="mx-auto grid gap-7 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:px-10">
        <article className="min-w-0">
          <div className="relative overflow-hidden rounded-lg pb-6 pt-2 lg:grid lg:min-h-[360px] lg:grid-cols-[minmax(0,1fr)_minmax(330px,0.82fr)] lg:items-center lg:gap-8 lg:pb-8 lg:pt-3">
            <div className="relative z-10">
              <nav className="mb-3 flex flex-wrap items-center gap-2 text-[11px] font-bold text-[#7d7085]" aria-label="Article breadcrumb">
                ...
                <span>/</span>
                <span className="text-[#4b345d]">Confusion & Disorientation Support</span>
              </nav>
          ...
          <section id="introduction" className="mt-8">
            ...
            <div className="mt-5 rounded-lg bg-[#f4ecf8] p-5">
              <h3 className="mb-2 text-[14px] font-bold text-[#3b2e45]">At Manovaidya, Confusion & Disorientation Support Focuses On</h3>
            ...
            <div className="p-7">
              ...
              <div className="mt-6">
                ...
                <ul className="grid gap-3 sm:grid-cols-2">
                  {["Book Consultation", "Speak With Our Team", "Get Personalized Guidance", "Confusion & Disorientation Support", "Healthy Cognitive Ageing Guidance"].map((step) => <li key={step} className="flex gap-2 text-[14px] font-bold"><CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-[#d8b4e2]" />{step}</li>)}
                </ul>
              </div>
        ...
        <div className="sticky top-24 max-h-[calc(100vh-6rem)] space-y-5 overflow-y-auto pb-5">
          ...
          <SidebarCard><h2 className="text-[15px] font-black text-[#21142d]">Related Pages</h2><div className="mt-4 space-y-2">{relatedPages.map((title) => <a key={title} href="#why-families-choose" className="block rounded-md bg-[#fbf9fd] px-3 py-2 text-[12px] font-bold text-[#51465a] transition hover:bg-[#f0e7f6] hover:text-[#7835A4]">{title}</a>)}</div></SidebarCard>
