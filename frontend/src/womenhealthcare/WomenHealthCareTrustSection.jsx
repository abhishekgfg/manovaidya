...
const faqs = [
  {
    ...
    answer: "Common signs include persistent worry, sleep changes, irritability, fatigue and difficulty concentrating.",
  },
  {
    question: "When should I seek help for my mental health?",
    answer: "Consider professional support when symptoms persist, feel overwhelming or begin affecting daily life and relationships.",
  },
  {
    question: "How do I know if I have PMS or PMDD?",
    answer: "A qualified professional can assess symptom timing, severity and its connection with your menstrual cycle.",
  },
  {
    question: "Is online counselling effective for women?",
    answer: "Yes. Online counselling can provide private, accessible and consistent support from wherever you feel comfortable.",
  },
  {
    question: "How can I manage mood swings naturally?",
    answer: "Sleep, movement, balanced nutrition, stress regulation and professional guidance can all support steadier moods.",
  },
  {
    question: "Can therapy help with relationship issues?",
    answer: "Therapy can improve communication, boundaries, emotional awareness and healthier relationship patterns.",
  },
  {
    question: "How long does it take to see improvement?",
    answer: "Every person is different. Progress depends on your needs, goals, consistency and the care approach used.",
  },
  {
    question: "What therapies do you offer for women?",
    answer: "Care may include evidence-informed counselling, CBT, ACT, mindfulness and personalized holistic support.",
  },
  {
    question: "Is my information kept confidential?",
    answer: "Yes. Your personal information and sessions are handled with privacy, respect and professional confidentiality.",
  },
];
      ...
      <div className="mx-auto max-w-[1440px] overflow-hidden rounded-lg border border-[#edeaf6] bg-white shadow-[0_14px_40px_rgba(47,32,113,0.08)]">
        ...
        <div className="grid gap-6 border-b border-[#eeeaf7] bg-[#fdfcff] p-6 md:grid-cols-[minmax(0,1fr)_minmax(440px,0.95fr)] lg:p-7">
          <div className="grid items-center gap-6 sm:grid-cols-[165px_minmax(0,1fr)]">
            ...
            <div>
              <h3 className="font-serif text-[27px] font-bold text-[#38267e]">About Dr. Ankush Garg</h3>
        ...
        <div id="women-faqs" className="px-5 py-5 lg:px-8 lg:py-6">
          <div className="flex items-center justify-between gap-4">
            <h3 className="font-serif text-[26px] font-bold text-[#372575]">Frequently Asked Questions</h3>
