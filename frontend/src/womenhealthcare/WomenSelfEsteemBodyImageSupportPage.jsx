...
function WomenSelfEsteemBodyImageSupportPage() {
  ...
  React.useEffect(() => {
    document.title = "Self-Esteem & Body Image Support for Women in India | Manovaidya";
    ...
    updateMeta("description", "Looking for Self-Esteem & Body Image Support for Women in India? Learn about low self-esteem, body image concerns, self-confidence, emotional wellbeing and the Neuro-Ayurveda approach at Manovaidya.");
  }, []);
